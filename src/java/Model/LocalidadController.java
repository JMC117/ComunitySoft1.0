...
public class LocalidadController implements Serializable {
    ...
    @EJB
    private Model.LocalidadFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("LocalidadCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("LocalidadUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("LocalidadDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public Localidad getLocalidad(java.lang.Integer id) {
